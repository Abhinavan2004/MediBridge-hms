    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card doctor-card">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title">Dr. Himanshu Johnson</h5>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card doctor-card">
                        <img src="assets/doctor_2.jpg" class="doctor-img" alt="Dr. Sarah Johnson">
                        <div class="card-body text-center">
                            <h5 class="card-title">Dr. Ashwin Awasti</h5>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card doctor-card">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title">Dr. James Rodriguez</h5>
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="review-card">
                        ...
                        <p class="mb-3">"Excellent service and professional staff. The doctors are very knowledgeable and caring. I highly recommend MediBridge."</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="Admin.jsp" class="text-white-50">Admin</a></li>
                        <li><a href="User.jsp" class="text-white-50">User</a></li>
                        <li><a href="Redirection.jsp" class="text-white-50">Appointment</a></li>
                        <li><a href="doctor.jsp" class="text-white-50">Doctor</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 mb-4">
                    ...
                    <ul class="list-unstyled text-white-50">
                        <li><i class="fas fa-map-marker-alt me-2"></i>456, Medical Square, Nagpur , Maharashtra</li>
                        <li><i class="fas fa-phone me-2"></i>+91-1234567891</li>
                        <li><i class="fas fa-envelope me-2"></i>medibridge_info@gmail.com</li>
                    </ul>	
                </div>
            </div>
            <hr class="my-4">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p class="text-white-50 mb-0">&copy; 2025 MediBridge. All rights reserved.</p>
                </div>
            </div>
        </div>
