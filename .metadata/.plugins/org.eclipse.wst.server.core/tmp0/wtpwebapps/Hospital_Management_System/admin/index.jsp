...
<%@ page
	import="com.DAO.DoctorDao, com.db.DBConnect"%>
    ...
    <div class="container">
                    ...
                    <div class="card-body p-0">
                        <div class="stat-card-content">
                            ...
                            <div class="stat-info">
                                ...
                                <p class="stat-number"><%=dao.countAppointments() %></p>
                    ...
                    <div class="card-body p-0">
                        <div class="stat-card-content">
                            ...
                            <div class="stat-info">
                                ...
                                <p class="stat-number"><%=dao.countDoctors() %></p>
                ...
                <div class="card stat-card specialists">
                    <div class="card-body p-0">
                        <div class="stat-card-content">
                            ...
                            <div class="stat-info">
                                <h3>Specialists</h3>
                                <p class="stat-number"><%=dao.countSpecialists() %></p>
                    ...
                    <div class="card-body p-0">
                        <div class="stat-card-content">
                            ...
                            <div class="stat-info">
                                ...
                                <p class="stat-number"><%=dao.countUsers()%></p>
        ...
        <div class="quick-actions-section">
            ...
            <div class="quick-actions">
                <button class="btn action-btn primary" onclick="location.href='/User_index.jsp'">
