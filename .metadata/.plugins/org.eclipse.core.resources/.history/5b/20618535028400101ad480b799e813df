...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .card-header, .card-body, .submit-section {
            padding: 1.5rem;
        }
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                ...
                <p>Schedule your medical consultation with our expert doctors</p>
            </div>
        </div>
    </div>
</div>
...
<div class="main-content">
                        ...
                        <form action="bookAppointment" method="post" id="appointmentForm">
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="appointmentDate" class="form-label">Appointment Date <span class="required">*</span></label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="phoneNo" class="form-label">Phone Number <span class="required">*</span></label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                    <i class="fas fa-phone"></i>
                                                </span>
                                                <input type="tel" class="form-control" id="phoneNo" name="phoneNo" 
                                                       placeholder="+91 XXXXXXXXXX" pattern="[0-9]{10}" required>
                                            </div>
                                            <div class="form-text">Please enter 10-digit mobile number</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="diseases" class="form-label">Medical Condition</label>
                                            <div class="input-group">
                                                <span class="input-group-text">
    ...
    <option value="">Select Doctor (Optional)</option>
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    <label for="fullAddress" class="form-label">Full Address <span class="required">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text">
                                    ...
                                    <div class="form-text">Please include street address, city, state, and postal code</div>
                                </div>
                            </div>
                    ...
                    <div class="submit-section">
                        <button type="submit" form="appointmentForm" class="btn btn-submit mb-8">
