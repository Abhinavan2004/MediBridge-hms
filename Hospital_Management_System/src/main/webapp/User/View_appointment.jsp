...
<%@ page import="com.DAO.AppointmentDao, com.DAO.DoctorDao, com.db.DBConnect, com.entity.Appointment_entity, com.entity.User, com.entity.Doctor_entity, java.util.*"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>MediBridge : View Appointments</title>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="appointment-card">
                        ...
                        <table class="table custom-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%=d != null ? d.getDoc_name() : "N/A"%></td>
                                    <td>
                                        <%
                                        ...
                                        %>
                                            <span class="status-badge status-ok"><%=ap.getApp_status()%></span>
                                        <%
                                        }
                                        %>
                                    </td>
                    ...
                    <div class="no-appointments">
                        ...
                        <a href="../User/User_index.jsp" class="btn btn-success">Book Your First Appointment</a>
                    </div>
                    <%
                        }
                    } else {
                    ...
                    <div class="no-appointments">
                        ...
                        <a href="../User/user_login.jsp" class="btn btn-primary">Login Now</a>
                    </div>
                    <%
                    }
                    %>
